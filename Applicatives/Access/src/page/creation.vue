            ...
            <div class="card card1">
                <div class="row justify-content-center my-auto">
                    <div class="col-md-10 col-10 my-2">
                        <h3 class="mb-2 text-center heading">Rejoins-nous</h3>
                        ...
                        <div class="col-6">
                            <label class="form-control-label text-muted">Prénom</label>
                            <input type="text" class="form-control" id="firstname" name="firstname" placeholder="Prénom" v-model="firstname">
                        </div>
                        <br/>
                         <div class="col-6">
                            <label class="form-control-label text-muted">Nom</label>
                            <input type="text" class="form-control" id="name" name="name" placeholder="Nom" v-model="name">
                        </div>
                        </div>

                        <div class="form-group">
                            <label class="form-control-label text-muted">Adresse mail</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Saisis ton e-mail" v-model="email">
                        </div>
                        ...
                        <div class="row justify-content-center my-2 px-3">
                            <button class="btn-block btn-color" type="submit">S'inscrire</button>
                        </div>
                        </form>
                    </div>
                </div>
                <div class="bottom text-center mb-1">
                    <p href="#" class="sm-text mx-auto mb-3">Tu as déja un compte ?</p>
                    <div class="button--white">
                        <button class="btn btn-white ml-2 "><router-link to="/connexion" exact>Se connecter</router-link></button>
